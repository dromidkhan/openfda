  ...
  render () {
    ...
    return (
      <section className='doc-content'>
        ...
        <APIUseSteps endpoint_name='Drug Solid Oral Dosage Form Imprint' endpoint_path='/apis/drug/imprint/'/>
        ...
        <p>In the example below, we are searching the records in the drug Solid Oral Dosage Form Imprint endpoint for matches with <code>Class III</code> in the <code>classification</code> field. We are requesting to see the first 5 records that match."</p>
        <APIQueryBreakdown endpoint_path='/drug/imprint.json' query='color:white'/>

        <h3>Some key pointers</h3>
        <ul>
          <li>An openFDA query always begins with the base endpoint, which in this case is: <code>https://api.fda.gov/drug/imprint.json</code></li>
