...
// Update total usage numbers with: https://api.fda.gov/usage.json?end_at=2023-07-05 - last 2023-07-05
            ...
            <div>
              <table className="table-sm table-bordered">
                <tbody>
                  ...
                  <tr><td>Solid Oral Dosage Form Imprint</td><td>{this.docCount('drugimprint')}</td></tr>
              ...
              <div className='marg-t-2 b-t-2 pad-t-2'>
                ...
                <div>
                  <table className="table-sm table-bordered">
                    ...
                    <tr><td>Solid Oral Dosage Form Imprint</td><td>{this.downloadCount('drugimprint')}</td></tr>
